        ...
        try {
            ...
            if(!fileIsExist()){
                ...
                if(!file.canWrite()){
                    ...
                    FXMLLoader loader=new FXMLLoader(getClass().getResource("/layouts/new-pass-dialog.fxml"));
    ...
    void onUnlockFile(ActionEvent event) {
        try {
            ...
            if(!fileIsExist()){
                ...
                window.initModality(Modality.APPLICATION_MODAL);
                FXMLLoader loader=new FXMLLoader(getClass().getResource("/layouts/pass-dialog.fxml"));
